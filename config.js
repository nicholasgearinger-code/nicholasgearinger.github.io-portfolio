...
const PROJECTS = [
  {
    id: 'generative-copilot',
    title: 'Generative Copilot',
    tagline: 'An LLM copilot used by 40k+ people',
    year: 2024,
    role: 'Lead Design & Prototyping',
    tags: ['LLM', 'Product Design', 'React'],
    featured: true,
  },
  {
    id: 'model-eval-suite',
    title: 'Model Evaluation Suite',
    tagline: 'Dashboards behind three production ML features',
    year: 2023,
    role: 'Product Designer',
    tags: ['Data Viz', 'ML Ops', 'Design Systems'],
    featured: false,
  },
  {
    id: 'realtime-3d-canvas',
    title: 'Realtime 3D Canvas',
    tagline: 'Creative-coding prototype pipeline',
    year: 2022,
    role: 'UX Engineer',
