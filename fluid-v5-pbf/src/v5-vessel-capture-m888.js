...
`  let inside0=p0.y>base-pr*1.4 && p0.y<rim+pr*2.4 && gr0<gi0+pr*.55;`);
      code=code.replace(
...
window.__fluidV5Build='M8.8.8 CLEAN CATCH / WIDER GLASS / LOWER-ENERGY POUR / M8.8.1 FLUID PHYSICS';
window.__v5M888={
  ...
  capture:'near-rim-boundary-projection',phase
};
